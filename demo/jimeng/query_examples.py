...
Actual API calls require valid token and video ID.
"""
...
def example_simple_query():
    ...
    # Video ID from generate_video response
    video_id = "jimeng:7391ad0e-9813-48ba-a742-ed0720e44e45"

    print("Querying video status...")
    print(f"Video ID: {video_id}")
    print(f"Query URL: https://yunwu.ai/v1/video/query?id={video_id}")
...
# ============================================================================
# EXAMPLE 2: Query with Different Video IDs
# ============================================================================
def example_multiple_queries():
    ...
    print("Querying multiple videos...")
...
def example_custom_timeout():
    ...
    # result = wait_for_video_completion(client, video_id, timeout=30, poll_interval=5)
    ...
    # result = wait_for_video_completion(client, video_id, timeout=600, poll_interval=10)
    ...
    # result = wait_for_video_completion(client, video_id, timeout=1800, poll_interval=30)
...
def example_batch_query():
    ...
    print(f"Querying {len(video_ids)} videos")
    print()
...
if __name__ == "__main__":
    print("=" * 80)
    print("Jimeng Video Query Examples")
    print("=" * 80)
